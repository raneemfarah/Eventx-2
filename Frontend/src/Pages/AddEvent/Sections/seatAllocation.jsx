...
const SeatAllocation = ({ totalSeats = 25, paidSeats = [], reservedSeats = [], onSeatSelect }) => {
  const [selectedSeats, setSelectedSeats] = useState(reservedSeats);
  ...
  return (
    <div className="mb-6">
      <h3 className="text-lg font-semibold mb-2 text-gray-800">Seat Allocation</h3>
      ...
      <div className="mt-4 text-gray-600 text-sm flex gap-6">
